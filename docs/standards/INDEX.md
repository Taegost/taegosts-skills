...
- **`docs/standards/`** — authored, enforced policy. Documents here state rules directly ("MUST", "is the only allowed pattern") and end in a **Conformance** or **Conformance Checklist** section. They are the canonical spec a skill or script is validated against.
