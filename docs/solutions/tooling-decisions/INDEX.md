...
| [compliance-gate-scope-classification.md](./compliance-gate-scope-classification.md) | Issue #118 tracked three residuals deliberately left out of PR #116's scope, all centered on `scripts/verify-scripts.sh` (the pre-commit gate for script compliance) and the repo's test machinery: |
