...
Read this reference when Phase 1.75 fires (after investigating individual docs, before Phase 2 classification). The goal is to catch problems that only become visible when comparing docs to each other — not just to reality.
