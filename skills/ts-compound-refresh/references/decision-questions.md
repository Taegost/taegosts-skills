# Decision Questions (Interactive Mode)

Read this reference when Phase 3 fires in interactive mode. Headless mode skips Phase 3 entirely (see SKILL.md) and never needs this file.
...
Always present choices using the blocking question tool (see SKILL.md's Question Tool Convention).
