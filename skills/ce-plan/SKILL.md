...
- **Execute the plan** — Proceed to implementation with the plan path as input. Do not merely tell the user what to do next — start the implementation now so the plan executes in this session.
