...
1. Identify which project configuration files exist at the repo root. Read the file(s) and determine which holds the substantive content. If none exist, skip this check entirely.
